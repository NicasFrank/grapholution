...
public class GameRunner{
    ...
    */
    public static void test(){
        ...
        while(true){
            if(game.getDone() == true){
                if(game.getWin() == true){    //If the player wins.
                    System.out.println("You win!");
                    game.onEnd();
                    break;
                }if(game.getDone() == true){                       //If the player loses.
                    game.onEnd();
                    break;
                }if(game.getDone() == false){                      //While the player hasn't lost or won.
                    x = -1;
                    y = -1;     //Resets values.
                    System.out.print("Enter an x coordinate.");
                    y = scan.nextInt();
