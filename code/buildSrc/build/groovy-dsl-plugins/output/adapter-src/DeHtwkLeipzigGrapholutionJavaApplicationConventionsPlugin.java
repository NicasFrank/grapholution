...
/**
 * Precompiled de.htwk.leipzig.grapholution.java-application-conventions script plugin.
 **/
public class DeHtwkLeipzigGrapholutionJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        assertSupportedByCurrentGradleVersion();
                target.getPluginManager().apply("de.htwk.leipzig.grapholution.java-common-conventions");
        target.getPluginManager().apply("application");

        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_DeHtwkLeipzigGrapholutionJavaApplicationConventions").asSubclass(BasicScript.class);
