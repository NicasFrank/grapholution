...
/**
 * Precompiled de.htwk.leipzig.grapholution.java-common-conventions script plugin.
 **/
public class DeHtwkLeipzigGrapholutionJavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_DeHtwkLeipzigGrapholutionJavaCommonConventions").asSubclass(BasicScript.class);
