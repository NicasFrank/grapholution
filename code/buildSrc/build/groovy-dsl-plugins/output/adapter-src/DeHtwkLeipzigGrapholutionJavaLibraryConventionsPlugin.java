...
/**
 * Precompiled de.htwk.leipzig.grapholution.java-library-conventions script plugin.
 **/
public class DeHtwkLeipzigGrapholutionJavaLibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_DeHtwkLeipzigGrapholutionJavaLibraryConventions").asSubclass(BasicScript.class);
